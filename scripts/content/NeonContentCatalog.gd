...
static func level_upgrade_pool() -> Array:
	return [
		...
		{"id": "fractal_shard_unlock", "title": "Fractal Shard", "description": "Adds a heavy shard that splits on impact", "category": "new weapon", "shape": "Dark diamond shard", "effects": {"fractal_shard_enable": true}},
		{"id": "fractal_shard_core", "title": "Fractal Core", "description": "Unlocks Fractal Shard, +18% shard damage", "category": "fractal damage", "shape": "Stacked triangle core", "effects": {"fractal_shard_enable": true, "fractal_shard_damage_multiplier_add": 0.18}},
		{"id": "fractal_shard_splitter", "title": "Fractal Splitter", "description": "Unlocks Fractal Shard, +2 split shards", "category": "fractal split", "shape": "Triangle shard fan", "effects": {"fractal_shard_enable": true, "fractal_shard_split_add": 2}},
		{"id": "fractal_coolant", "title": "Fractal Coolant", "description": "Unlocks Fractal Shard, -14% cooldown", "category": "fractal rate", "shape": "Cyan prism sink", "effects": {"fractal_shard_enable": true, "fractal_shard_cooldown_multiplier_add": -0.14}},
		{"id": "fractal_tail", "title": "Fractal Tail", "description": "Unlocks Fractal Shard, +0.22s lifetime", "category": "fractal reach", "shape": "Long shard rail", "effects": {"fractal_shard_enable": true, "fractal_shard_life_add": 0.22}},
		{"id": "fractal_aperture", "title": "Fractal Aperture", "description": "Unlocks Fractal Shard, +1 primary pierce", "category": "fractal pierce", "shape": "Diamond aperture", "effects": {"fractal_shard_enable": true, "fractal_shard_pierce_add": 1}},
		...
		{"id": "warden_cache", "title": "Warden Cache", "description": "+6 Prism Warden bonus XP", "category": "mini-boss reward", "shape": "Dodecahedron cache", "effects": {"mini_boss_reward_bonus_add": 6}}
	].duplicate(true)
	...
	return [
		{
			...
			"warning_wave": "WARDEN WARNING",
			"boss_wave": "PRISM WARDEN",
			"boss_type": "mini_boss",
			"boss_name": "PRISM WARDEN",
			"warning_time": 54.0,
			"boss_time": 72.0,
			"transition_message": "PRISM RIFT VECTOR OPEN",
			"clear_condition": "Defeat Prism Warden",
			"boss_trim_keep": 18,
		...
		},
		{
			...
			"warning_wave": "CROWN WARNING",
			"boss_wave": "FRACTAL CROWN",
			"boss_type": "fractal_crown",
			"boss_name": "FRACTAL CROWN",
			"warning_time": 66.0,
			"boss_time": 90.0,
			"transition_message": "NULL ZONE GATE UNSEALED",
			"clear_condition": "Defeat Fractal Crown",
			"boss_trim_keep": 16,
		...
		{
			"name": "Null Zone",
			"intro_wave": "VOID ENTRY",
			"pressure_wave": "DARK GEOMETRY",
			"peak_wave": "NULL SURGE",
			"warning_wave": "OCTAGON WARNING",
			"boss_wave": "NULL OCTAGON",
			"boss_type": "null_octagon",
			"boss_name": "NULL OCTAGON",
			"warning_time": 72.0,
			"boss_time": 98.0,
			"transition_message": "HYPER GRID VECTOR CHARGED",
			"clear_condition": "Defeat Null Octagon",
			"boss_trim_keep": 14,
		...
		},
		{
			...
			"warning_wave": "PRIME OCTAGON WARNING",
			"boss_wave": "NULL OCTAGON PRIME",
			"boss_type": "final_null_octagon",
			"boss_name": "NULL OCTAGON PRIME",
			"warning_time": 64.0,
			"boss_time": 88.0,
			"transition_message": "RUN COMPLETE VECTOR",
			"clear_condition": "Defeat Null Octagon Prime",
			"boss_trim_keep": 12,
...
static func _sector_3_enemy_mixes() -> Array:
	return [
		[{"type": "hex_slicer", "weight": 0.18}, {"type": "prism_leech", "weight": 0.17}, {"type": "shield_node", "weight": 0.13}, {"type": "hex_pulser", "weight": 0.13}, {"type": "triad_splitter", "weight": 0.11}, {"type": "shooter", "weight": 0.10}, {"type": "spiral_drifter", "weight": 0.08}, {"type": "exploder", "weight": 0.07}, {"type": "tank", "weight": 0.03}],
		[{"type": "prism_leech", "weight": 0.20}, {"type": "hex_slicer", "weight": 0.19}, {"type": "shield_node", "weight": 0.15}, {"type": "hex_pulser", "weight": 0.14}, {"type": "triad_splitter", "weight": 0.12}, {"type": "exploder", "weight": 0.10}, {"type": "shooter", "weight": 0.07}, {"type": "spiral_drifter", "weight": 0.03}],
		[{"type": "prism_leech", "weight": 0.19}, {"type": "hex_slicer", "weight": 0.18}, {"type": "shield_node", "weight": 0.15}, {"type": "hex_pulser", "weight": 0.15}, {"type": "triad_splitter", "weight": 0.13}, {"type": "exploder", "weight": 0.12}, {"type": "shooter", "weight": 0.06}, {"type": "spiral_drifter", "weight": 0.02}],
		[{"type": "prism_leech", "weight": 0.19}, {"type": "hex_slicer", "weight": 0.18}, {"type": "shield_node", "weight": 0.15}, {"type": "hex_pulser", "weight": 0.15}, {"type": "triad_splitter", "weight": 0.13}, {"type": "exploder", "weight": 0.12}, {"type": "shooter", "weight": 0.06}, {"type": "spiral_drifter", "weight": 0.02}],
		[{"type": "prism_leech", "weight": 0.18}, {"type": "hex_slicer", "weight": 0.18}, {"type": "shield_node", "weight": 0.15}, {"type": "hex_pulser", "weight": 0.15}, {"type": "triad_splitter", "weight": 0.13}, {"type": "exploder", "weight": 0.12}, {"type": "shooter", "weight": 0.06}, {"type": "spiral_drifter", "weight": 0.03}],
		[{"type": "prism_leech", "weight": 0.18}, {"type": "hex_slicer", "weight": 0.18}, {"type": "shield_node", "weight": 0.15}, {"type": "hex_pulser", "weight": 0.15}, {"type": "triad_splitter", "weight": 0.13}, {"type": "exploder", "weight": 0.12}, {"type": "shooter", "weight": 0.06}, {"type": "spiral_drifter", "weight": 0.03}]
	]
...
static func _sector_4_enemy_mixes() -> Array:
	return [
		[{"type": "hex_slicer", "weight": 0.20}, {"type": "spiral_drifter", "weight": 0.16}, {"type": "hex_pulser", "weight": 0.12}, {"type": "shield_node", "weight": 0.10}, {"type": "shooter", "weight": 0.12}, {"type": "triad_splitter", "weight": 0.08}, {"type": "prism_leech", "weight": 0.06}, {"type": "chaser", "weight": 0.14}, {"type": "exploder", "weight": 0.02}],
		[{"type": "hex_slicer", "weight": 0.22}, {"type": "spiral_drifter", "weight": 0.15}, {"type": "hex_pulser", "weight": 0.15}, {"type": "shield_node", "weight": 0.13}, {"type": "triad_splitter", "weight": 0.11}, {"type": "prism_leech", "weight": 0.10}, {"type": "shooter", "weight": 0.08}, {"type": "exploder", "weight": 0.06}],
		[{"type": "hex_slicer", "weight": 0.22}, {"type": "hex_pulser", "weight": 0.17}, {"type": "shield_node", "weight": 0.15}, {"type": "triad_splitter", "weight": 0.13}, {"type": "prism_leech", "weight": 0.13}, {"type": "exploder", "weight": 0.10}, {"type": "spiral_drifter", "weight": 0.07}, {"type": "shooter", "weight": 0.03}],
		[{"type": "hex_slicer", "weight": 0.22}, {"type": "hex_pulser", "weight": 0.17}, {"type": "shield_node", "weight": 0.15}, {"type": "triad_splitter", "weight": 0.13}, {"type": "prism_leech", "weight": 0.13}, {"type": "exploder", "weight": 0.10}, {"type": "spiral_drifter", "weight": 0.07}, {"type": "shooter", "weight": 0.03}],
		[{"type": "hex_slicer", "weight": 0.19}, {"type": "hex_pulser", "weight": 0.16}, {"type": "shield_node", "weight": 0.14}, {"type": "triad_splitter", "weight": 0.12}, {"type": "prism_leech", "weight": 0.12}, {"type": "exploder", "weight": 0.10}, {"type": "spiral_drifter", "weight": 0.09}, {"type": "shooter", "weight": 0.08}],
		[{"type": "hex_slicer", "weight": 0.19}, {"type": "hex_pulser", "weight": 0.16}, {"type": "shield_node", "weight": 0.14}, {"type": "triad_splitter", "weight": 0.12}, {"type": "prism_leech", "weight": 0.12}, {"type": "exploder", "weight": 0.10}, {"type": "spiral_drifter", "weight": 0.09}, {"type": "shooter", "weight": 0.08}]
	]
